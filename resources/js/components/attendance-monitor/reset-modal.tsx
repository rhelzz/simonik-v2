...
/**
 * Reset data absen — DESTRUKTIF dan tidak bisa dibatalkan.
 *
 ...
 */
export function ResetAttendanceModal({
    open,
    onClose,
    departemens,
    classOptions,
                ...
                <div className="rounded-2xl bg-canvas p-3 text-center">
                    {counting ? (
                        ...
                        <p className="text-sm text-ink">
                            ...
                            baris data absen akan dihapus permanen.
                        </p>
                    )}
                </div>
